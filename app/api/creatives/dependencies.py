...
async def get_creatives(
    ...
    ads, cursor, keyword_index = await fb_driver.search_ads(**creative_request.dict(exclude={"telegram_id"}))
    ...
    return {"ads": result, "after": cursor, "keyword_index": keyword_index}
